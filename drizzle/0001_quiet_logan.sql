ALTER TABLE `brands` RENAME TO `makers`;--> statement-breakpoint
...
CREATE TABLE `__new_models` (
	...
	FOREIGN KEY (`brand_id`) REFERENCES `makers`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
INSERT INTO `__new_models`("id", "brand_id", "name", "slug", "url", "image_url", "image_local_path", "announced", "status", "dimensions", "weight", "build", "sim", "display_type", "display_size", "display_resolution", "display_protection", "os", "chipset", "cpu", "gpu", "card_slot", "internal_memory", "main_camera", "main_camera_features", "main_camera_video", "selfie_camera", "selfie_features", "selfie_video", "battery", "battery_charging", "network_tech", "sensors", "colors", "models_text", "price", "meta", "scraped", "created_at") SELECT "id", "brand_id", "name", "slug", "url", "image_url", "image_local_path", "announced", "status", "dimensions", "weight", "build", "sim", "display_type", "display_size", "display_resolution", "display_protection", "os", "chipset", "cpu", "gpu", "card_slot", "internal_memory", "main_camera", "main_camera_features", "main_camera_video", "selfie_camera", "selfie_features", "selfie_video", "battery", "battery_charging", "network_tech", "sensors", "colors", "models_text", "price", "meta", "scraped", "created_at" FROM `models`;--> statement-breakpoint
